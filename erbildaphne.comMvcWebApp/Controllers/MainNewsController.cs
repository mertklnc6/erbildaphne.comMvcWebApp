...
namespace erbildaphne.comMvcWebApp.Controllers
{
    public class MainNewsController : Controller
    {
        ...
        public MainNewsController(IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<IActionResult> Create(int id)
        {
            ...
            if (roleClaims != null)
            {               
                    return View(new MainNewsViewModel()); // Burada MainNewsViewModel nesnesi geçiriliyor.
        ...
        public async Task<IActionResult> Create(MainNewsViewModel model, IFormFile image)
        {
            // Resim yükleme
            try
            {
                var uploadPath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot\\uploads\\mainNewss");
                ...
                model.PictureUrl = "/uploads/mainNewss/" + uniqueImageFileName;
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                if (roleClaims != null)
                {
                    ...
                    var result = await http.PostAsync("mainNews/create/", content);
        ...
        {
            var http = _httpClientFactory.CreateClient("Client");
            var result = await http.GetAsync("mainNews/getById/" + id.ToString());
            ...
            {
                var jsonData = await result.Content.ReadAsStringAsync();
                var data = JsonConvert.DeserializeObject<MainNewsViewModel>(jsonData);                
                //Json Serialize işlemleri için NewtonSoft paketini yüklüyoruz.
                return View(data);
            }
            else
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            if (roleClaims != null)
            {
                var mainNewsResult = await http.GetAsync("mainNews/getById/" + id.ToString());
                

                if (mainNewsResult.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    var mainNewsJsonData = await mainNewsResult.Content.ReadAsStringAsync();
                    var mainNewsData = JsonConvert.DeserializeObject<MainNewsViewModel>(mainNewsJsonData);                    
                    return View(mainNewsData);
                }
                else
                {
                    return View("Error");
        ...
        public async Task<IActionResult> Edit(int id, MainNewsViewModel model, IFormFile? image)
        {
            ...
            if (id == model.Id)
            {
                if (image != null)
                {
                    var uploadPath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot\\uploads\\mainNews");
                    ...
                    model.PictureUrl = "/uploads/mainNews/" + uniqueImageFileName;
                }
                ...
                {
                    var mainNewsResult = await http.GetAsync("mainNews/getById/" + id.ToString());
                    var existing = await mainNewsResult.Content.ReadAsStringAsync();
                    var existingData = JsonConvert.DeserializeObject<MainNewsViewModel>(existing);
                    ...
                    var content = new StringContent(jsonContent, Encoding.UTF8, "application/json");
                    var result = await http.PutAsync("mainNews/edit/" + id.ToString(), content);
        ...
        public async Task<IActionResult> Publish(int id)
        {
            ...
            if (roleClaims != null)
            {
                ...
                if (mainNewsResult.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    ...
                    mainNewsData.IsPublished = !mainNewsData.IsPublished;

                    // Güncellenmiş veriyi JSON'a dönüştür
                    var jsonContent = JsonConvert.SerializeObject(mainNewsData);
                    var content = new StringContent(jsonContent, Encoding.UTF8, "application/json");

                    // API'ye güncellenmiş veriyi gönder
                    var updateResult = await http.PutAsync("mainNews/edit/" + id.ToString(), content);
        ...
        public async Task<IActionResult> Boost(int id)
        {
            ...
            if (roleClaims != null)
            {
                ...
                if (mainNewsResult.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    ...
                    // Yayın durumunu değiştir
                    mainNewsData.IsBoosted = !mainNewsData.IsBoosted;
        ...
        public async Task<IActionResult> Chose(int id)
        {
            ...
            if (roleClaims != null)
            {
                ...
                if (mainNewsResult.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    ...
                    // Yayın durumunu değiştir
                    mainNewsData.IsChosen = !mainNewsData.IsChosen;
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            if (roleClaims != null)
            {
                ...
                {
                    var result = await http.DeleteAsync("mainNews/delete/" + id.ToString());
                    var error = result.Content.ReadAsStringAsync();
                    return RedirectToAction("List");
                }
                else
                {
                    ...
                    var jsonContent = JsonConvert.SerializeObject(existingData);
                    var content = new StringContent(jsonContent, Encoding.UTF8, "application/json");
                    var result2 = await http.PutAsync("mainNews/edit/" + id.ToString(), content);
